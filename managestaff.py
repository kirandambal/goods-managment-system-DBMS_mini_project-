...
def managestaff():
    ...
    title=Label(root,text="Staff Details",bd=10,relief=GROOVE,font=('times of roman',40,"bold"),bg="green",fg="white")
    ...
    m_title=Label(manage_frame,text="MANAGE STAFF",font=('times of roman',25,"bold"),bg="crimson",fg="white")
    m_title.grid(row=0,columnspan=2,pady=10,sticky="w")

    lb1=Label(manage_frame,text="ID",font=('times of roman',20,"bold"),bg="crimson",fg="white")
    ...
    lb2=Label(manage_frame,text="NAME",font=('times of roman',20,"bold"),bg="crimson",fg="white")
    ...
    lb3=Label(manage_frame,text="CONTACT",font=('times of roman',20,"bold"),bg="crimson",fg="white")
    ...
    lb4=Label(manage_frame,text="EMAIL",font=('times of roman',20,"bold"),bg="crimson",fg="white")
    ...
    lb5=Label(manage_frame,text="GENDER",font=('times of roman',20,"bold"),bg="crimson",fg="white")
    ...
    lb6=Label(manage_frame,text="QUESTION",font=('times of roman',20,"bold"),bg="crimson",fg="white")
    ...
    lb7=Label(manage_frame,text="ANSWER",font=('times of roman',20,"bold"),bg="crimson",fg="white")
    ...
    lb8=Label(manage_frame,text="PASSWORD",font=('times of roman',20,"bold"),bg="crimson",fg="white")
